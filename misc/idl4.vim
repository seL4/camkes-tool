...
syn keyword IDLType interface refin in out inout procedure
syn keyword IDLCType int string char void unsigned signed integer character float double real boolean bool int8_t int16_t int32_t int64_t uint8_t uint16_t uint32_t uint64_t
