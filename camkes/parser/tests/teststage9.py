...
'''
    ...
    def test_old_multiple_connections(self):
        '''
        Test that the old syntax for declaring N-to-1 connections is correctly
        ...
        spec = '''
            ...
            assembly {
                composition {
                    ...
                    component Foo f2;
                    component Bar b;
                    connection C conn1(from f1.p, to b.p);
                    connection C conn2(from f2.p, to b.p);
                }
            }
        '''
